  ...
  return (
    <div className="grid w-full flex-grow items-center px-4 py-5 justify-center">
      ...
      />
            ...
            <h1 className="mt-4 text-xl font-medium tracking-tight text-black">Create an account</h1>
          </header>
          ...
          <div className="space-y-4">
            <Clerk.Field name="emailAddress" className="space-y-2">
              <Clerk.Label className="text-sm font-medium text-black">Email address</Clerk.Label>
              <Clerk.Input
                type="text"
                required
      ...
      />
            ...
            <h1 className="mt-4 text-xl font-medium tracking-tight text-black">Verify email code</h1>
          </header>
          <Clerk.GlobalError className="block text-sm text-red-400" />
